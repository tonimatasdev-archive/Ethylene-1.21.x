...
public class CraftSculkCatalyst extends CraftBlockEntityState<net.minecraft.world.level.block.entity.SculkCatalystBlockEntity> implements SculkCatalyst {

    public CraftSculkCatalyst(World world, net.minecraft.world.level.block.entity.SculkCatalystBlockEntity tileEntity) {
    ...
    public void bloom(Block block, int charge) {
        ...
        getTileEntity().getListener().getSculkSpreader().addCursors(new net.minecraft.core.BlockPos(block.getX(), block.getY(), block.getZ()), charge);
    }
