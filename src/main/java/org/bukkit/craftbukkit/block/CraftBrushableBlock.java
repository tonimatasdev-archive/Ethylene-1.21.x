...
public class CraftBrushableBlock extends CraftBlockEntityState<net.minecraft.world.level.block.entity.BrushableBlockEntity> implements BrushableBlock {

    public CraftBrushableBlock(World world, net.minecraft.world.level.block.entity.BrushableBlockEntity tileEntity) {
    ...
    @Override
    public void applyTo(net.minecraft.world.level.block.entity.BrushableBlockEntity lootable) {
