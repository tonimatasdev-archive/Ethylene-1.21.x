...
public class CraftSculkSensor<T extends net.minecraft.world.level.block.entity.SculkSensorBlockEntity> extends CraftBlockEntityState<T> implements SculkSensor {
