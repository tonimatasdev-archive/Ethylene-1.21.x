...
public abstract class CraftFurnace<T extends net.minecraft.world.level.block.entity.AbstractFurnaceBlockEntity> extends CraftContainer<T> implements Furnace {
    ...
    public void setBurnTime(short burnTime) {
        ...
        this.data = this.data.setValue(net.minecraft.world.level.block.AbstractFurnaceBlock.LIT, burnTime > 0);
    }
    ...
    public Map<CookingRecipe<?>, Integer> getRecipesUsed() {
        ...
        for (Map.Entry<net.minecraft.resources.ResourceLocation, Integer> entrySet : this.getSnapshot().getRecipesUsed().object2IntEntrySet()) {
