...
public class CraftStructureBlock extends CraftBlockEntityState<net.minecraft.world.level.block.entity.StructureBlockEntity> implements Structure {

    private static final int MAX_SIZE = 48;

    public CraftStructureBlock(World world, net.minecraft.world.level.block.entity.StructureBlockEntity tileEntity) {
    ...
    public void setRotation(StructureRotation rotation) {
        ...
        getSnapshot().rotation = net.minecraft.world.level.block.Rotation.valueOf(rotation.name());
    }
    ...
    public void setUsageMode(UsageMode mode) {
        ...
        getSnapshot().mode = net.minecraft.world.level.block.state.properties.StructureMode.valueOf(mode.name());
    }
    ...
    @Override
    protected void applyTo(net.minecraft.world.level.block.entity.StructureBlockEntity tileEntity) {
        ...
        if (access instanceof net.minecraft.world.level.Level) {
            ...
            // From net.minecraft.world.level.block.entity.StructureBlockEntity#setUsageMode(net.minecraft.world.level.block.state.properties.StructureMode)
