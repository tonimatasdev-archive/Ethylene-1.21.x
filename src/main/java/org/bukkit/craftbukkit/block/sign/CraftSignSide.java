...
public class CraftSignSide implements SignSide {
    ...
    public CraftSignSide(net.minecraft.world.level.block.entity.SignText signText) {
    ...
    public String[] getLines() {
        if (lines == null) {
            // Lazy initialization:
            net.minecraft.network.chat.Component[] messages = signText.getMessages(false);
    ...
    public net.minecraft.world.level.block.entity.SignText applyLegacyStringToSignSide() {
        if (lines != null) {
