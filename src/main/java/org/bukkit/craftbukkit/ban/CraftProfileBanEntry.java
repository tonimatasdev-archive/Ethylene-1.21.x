...
public final class CraftProfileBanEntry implements BanEntry<PlayerProfile> {
    ...
    @Override
    public void save() {
        net.minecraft.server.players.UserBanListEntry entry = new net.minecraft.server.players.UserBanListEntry(this.profile, this.created, this.source, this.expiration, this.reason);
        this.list.add(entry);
    }
