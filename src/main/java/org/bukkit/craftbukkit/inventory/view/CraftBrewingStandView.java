...
public class CraftBrewingStandView extends CraftInventoryView<net.minecraft.world.inventory.BrewingStandMenu> implements BrewingStandView {

    public CraftBrewingStandView(final HumanEntity player, final Inventory viewing, final net.minecraft.world.inventory.BrewingStandMenu container) {
