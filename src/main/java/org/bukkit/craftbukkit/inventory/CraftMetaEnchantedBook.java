...
class CraftMetaEnchantedBook extends CraftMetaItem implements EnchantmentStorageMeta {
    static final ItemMetaKeyType<net.minecraft.world.item.enchantment.ItemEnchantments> STORED_ENCHANTMENTS = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.STORED_ENCHANTMENTS, "stored-enchants");
    ...
    CraftMetaEnchantedBook(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
