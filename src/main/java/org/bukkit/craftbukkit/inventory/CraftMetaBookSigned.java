...
public class CraftMetaBookSigned extends CraftMetaItem implements BookMeta {
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.component.WrittenBookContent> BOOK_CONTENT = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.WRITTEN_BOOK_CONTENT);
    ...
    static final int MAX_PAGE_LENGTH = net.minecraft.world.item.component.WritableBookContent.PAGE_EDIT_LENGTH; // SPIGOT-6911: Use Minecraft limits
    static final int MAX_TITLE_LENGTH = net.minecraft.world.item.component.WrittenBookContent.TITLE_MAX_LENGTH; // SPIGOT-6911: Use Minecraft limits

    protected String title;
    protected String author;
    // Stored as components and serialized as JSON. See SPIGOT-5063, SPIGOT-5350, SPIGOT-3206
    protected List<net.minecraft.network.chat.Component> pages; // null and empty are two different states internally
    ...
    CraftMetaBookSigned(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
        ...
        getOrEmpty(tag, BOOK_CONTENT).ifPresent((written) -> {
            ...
            List<net.minecraft.server.network.Filterable<net.minecraft.network.chat.Component>> pages = written.pages();
            ...
            for (int i = 0; i < Math.min(pages.size(), MAX_PAGES); i++) {
                net.minecraft.network.chat.Component page = pages.get(i).raw();
    ...
    void applyToItem(CraftMetaItem.Applicator itemData) {
        ...
        if (pages != null) {
            ...
            for (net.minecraft.network.chat.Component page : pages) {
                list.add(net.minecraft.server.network.Filterable.passThrough(page));
            }
            itemData.put(BOOK_CONTENT, new net.minecraft.world.item.component.WrittenBookContent(net.minecraft.server.network.Filterable.from(net.minecraft.server.network.FilteredText.passThrough(title)), this.author, this.generation, list, this.resolved));
        }
    }
