...
public class CraftMetaShield extends CraftMetaItem implements ShieldMeta, BlockStateMeta {
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.DyeColor> BASE_COLOR = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.BASE_COLOR, "Base", "base-color");
    ...
    CraftMetaShield(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
    ...
    void applyToItem(CraftMetaItem.Applicator tag) {
        ...
        if (banner != null) {
            ...
            if (banner.numberOfPatterns() > 0) {
                ...
                tag.put(CraftMetaBanner.PATTERNS, new net.minecraft.world.level.block.entity.BannerPatternLayers(newPatterns));
            }
        }
    }
