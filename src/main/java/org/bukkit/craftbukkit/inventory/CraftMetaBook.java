...
public class CraftMetaBook extends CraftMetaItem implements BookMeta, WritableBookMeta {
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.component.WritableBookContent> BOOK_CONTENT = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.WRITABLE_BOOK_CONTENT);
    ...
    CraftMetaBook(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);

        getOrEmpty(tag, BOOK_CONTENT).ifPresent((writable) -> {
            List<net.minecraft.server.network.Filterable<String>> pages = writable.pages();
    ...
    void applyToItem(CraftMetaItem.Applicator itemData) {
        ...
        if (pages != null) {
            ...
            for (String page : pages) {
                list.add(net.minecraft.server.network.Filterable.from(net.minecraft.server.network.FilteredText.passThrough(page)));
            }
            itemData.put(BOOK_CONTENT, new net.minecraft.world.item.component.WritableBookContent(list));
        }
    }
