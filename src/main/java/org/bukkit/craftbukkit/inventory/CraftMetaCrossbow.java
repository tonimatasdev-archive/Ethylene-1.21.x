...
public class CraftMetaCrossbow extends CraftMetaItem implements CrossbowMeta {
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.component.ChargedProjectiles> CHARGED_PROJECTILES = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.CHARGED_PROJECTILES, "charged-projectiles");
    //
    ...
    CraftMetaCrossbow(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
    ...
    void applyToItem(CraftMetaItem.Applicator tag) {
        ...
        if (hasChargedProjectiles()) {
            ...
            tag.put(CHARGED_PROJECTILES, net.minecraft.world.item.component.ChargedProjectiles.of(list));
        }
    }
    ...
    public void addChargedProjectile(ItemStack item) {
        ...
        Preconditions.checkArgument(item.getType() == Material.FIREWORK_ROCKET || CraftItemType.bukkitToMinecraft(item.getType()) instanceof net.minecraft.world.item.ArrowItem, "Item %s is not an arrow or firework rocket", item);
