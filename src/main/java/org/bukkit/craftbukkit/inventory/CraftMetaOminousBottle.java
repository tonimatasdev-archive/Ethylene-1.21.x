...
public class CraftMetaOminousBottle extends CraftMetaItem implements OminousBottleMeta {
    ...
    static final ItemMetaKeyType<Integer> OMINOUS_BOTTLE_AMPLIFIER = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.OMINOUS_BOTTLE_AMPLIFIER, "ominous-bottle-amplifier");
    ...
    CraftMetaOminousBottle(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
