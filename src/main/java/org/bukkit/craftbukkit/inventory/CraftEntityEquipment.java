...
public class CraftEntityEquipment implements EntityEquipment {
    ...
    private void setDropChance(net.minecraft.world.entity.EquipmentSlot slot, float chance) {
        ...
        if (slot == net.minecraft.world.entity.EquipmentSlot.MAINHAND || slot == net.minecraft.world.entity.EquipmentSlot.OFFHAND) {
            ((net.minecraft.world.entity.Mob) entity.getHandle()).handDropChances[slot.getIndex()] = chance;
        } else {
            ((net.minecraft.world.entity.Mob) entity.getHandle()).armorDropChances[slot.getIndex()] = chance;
        }
    }
    ...
    private float getDropChance(net.minecraft.world.entity.EquipmentSlot slot) {
        ...
        if (slot == net.minecraft.world.entity.EquipmentSlot.MAINHAND || slot == net.minecraft.world.entity.EquipmentSlot.OFFHAND) {
            return ((net.minecraft.world.entity.Mob) entity.getHandle()).handDropChances[slot.getIndex()];
        } else {
            return ((net.minecraft.world.entity.Mob) entity.getHandle()).armorDropChances[slot.getIndex()];
        }
    }
}
