...
public class CraftMetaSuspiciousStew extends CraftMetaItem implements SuspiciousStewMeta {
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.component.SuspiciousStewEffects> EFFECTS = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.SUSPICIOUS_STEW_EFFECTS, "effects");
    ...
    CraftMetaSuspiciousStew(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
        getOrEmpty(tag, EFFECTS).ifPresent((suspiciousStewEffects) -> {
            List<net.minecraft.world.item.component.SuspiciousStewEffects.Entry> list = suspiciousStewEffects.effects();
            int length = list.size();
            customEffects = new ArrayList<>(length);

            for (int i = 0; i < length; i++) {
                net.minecraft.world.item.component.SuspiciousStewEffects.Entry effect = list.get(i);
    ...
    void applyToItem(CraftMetaItem.Applicator tag) {
        ...
        if (customEffects != null) {
            List<net.minecraft.world.item.component.SuspiciousStewEffects.Entry> effectList = new ArrayList<>();
            ...
            tag.put(EFFECTS, new net.minecraft.world.item.component.SuspiciousStewEffects(effectList));
        }
    }
