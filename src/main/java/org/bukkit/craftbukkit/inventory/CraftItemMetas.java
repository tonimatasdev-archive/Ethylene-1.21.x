...
public final class CraftItemMetas {
    ...
    public record ItemMetaData<I extends ItemMeta>(Class<I> metaClass, Function<net.minecraft.world.item.ItemStack, I> fromItemStack,
    ...
    public static <I extends ItemMeta> ItemMetaData<I> getItemMetaData(CraftItemType<?> itemType) {
        net.minecraft.world.item.Item itemHandle = itemType.getHandle();
        net.minecraft.world.level.block.Block blockHandle = (itemHandle instanceof net.minecraft.world.item.BlockItem itemBlock) ? itemBlock.getBlock() : null;
        ...
        if (itemHandle instanceof net.minecraft.world.item.BannerItem) {
            return asType(BANNER_META_DATA);
        }
        if (itemHandle instanceof net.minecraft.world.item.SpawnEggItem) {
        ...
        if (itemType == ItemType.FURNACE || itemType == ItemType.CHEST
                ...
                || itemHandle instanceof net.minecraft.world.item.SignItem || itemType == ItemType.SPAWNER
                ...
                || blockHandle instanceof net.minecraft.world.level.block.ShulkerBoxBlock
