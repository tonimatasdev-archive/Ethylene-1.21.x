...
class CraftMetaMap extends CraftMetaItem implements MapMeta {
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.component.MapPostProcessing> MAP_POST_PROCESSING = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.MAP_POST_PROCESSING);
    ...
    static final ItemMetaKeyType<net.minecraft.world.item.component.MapItemColor> MAP_COLOR = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.MAP_COLOR, "display-map-color");
    static final ItemMetaKeyType<net.minecraft.world.level.saveddata.maps.MapId> MAP_ID = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.MAP_ID, "map-id");
    ...
    CraftMetaMap(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);
        ...
        getOrEmpty(tag, MAP_POST_PROCESSING).ifPresent((mapPostProcessing) -> {
            this.scaling = (mapPostProcessing == net.minecraft.world.item.component.MapPostProcessing.SCALE) ? SCALING_TRUE : SCALING_FALSE;
        });
    ...
    void applyToItem(CraftMetaItem.Applicator tag) {
        ...
        if (hasMapId()) {
            tag.put(MAP_ID, new net.minecraft.world.level.saveddata.maps.MapId(getMapId()));
        }

        if (hasScaling()) {
            tag.put(MAP_POST_PROCESSING, (isScaling()) ? net.minecraft.world.item.component.MapPostProcessing.SCALE : net.minecraft.world.item.component.MapPostProcessing.LOCK);
        }

        if (hasColor()) {
            tag.put(MAP_COLOR, new net.minecraft.world.item.component.MapItemColor(color.asRGB()));
        }
    }
