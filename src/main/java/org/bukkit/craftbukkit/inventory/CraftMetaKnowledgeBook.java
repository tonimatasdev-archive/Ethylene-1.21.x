...
public class CraftMetaKnowledgeBook extends CraftMetaItem implements KnowledgeBookMeta {
    ...
    static final ItemMetaKeyType<List<net.minecraft.resources.ResourceLocation>> BOOK_RECIPES = new ItemMetaKeyType<>(net.minecraft.core.component.DataComponents.RECIPES, "Recipes");
    ...
    CraftMetaKnowledgeBook(net.minecraft.core.component.DataComponentPatch tag) {
        super(tag);

        getOrEmpty(tag, BOOK_RECIPES).ifPresent((pages) -> {
            for (int i = 0; i < pages.size(); i++) {
                net.minecraft.resources.ResourceLocation recipe = pages.get(i);
