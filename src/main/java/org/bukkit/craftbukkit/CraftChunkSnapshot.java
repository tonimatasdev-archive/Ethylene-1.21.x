...
public class CraftChunkSnapshot implements ChunkSnapshot {
    ...
    private final net.minecraft.world.level.chunk.PalettedContainer<net.minecraft.world.level.block.state.BlockState>[] blockids;
    private final byte[][] skylight;
    private final byte[][] emitlight;
    private final boolean[] empty;
    private final net.minecraft.world.level.levelgen.Heightmap hmap; // Height map
    private final long captureFulltime;
    private final net.minecraft.core.Registry<net.minecraft.world.level.biome.Biome> biomeRegistry;
    private final net.minecraft.world.level.chunk.PalettedContainerRO<net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome>>[] biome;

    CraftChunkSnapshot(int x, int z, int minHeight, int maxHeight, String wname, long wtime, net.minecraft.world.level.chunk.PalettedContainer<net.minecraft.world.level.block.state.BlockState>[] sectionBlockIDs, byte[][] sectionSkyLights, byte[][] sectionEmitLights, boolean[] sectionEmpty, net.minecraft.world.level.levelgen.Heightmap hmap, net.minecraft.core.Registry<net.minecraft.world.level.biome.Biome> biomeRegistry, net.minecraft.world.level.chunk.PalettedContainerRO<net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome>>[] biome) {
        this.x = x;
        this.z = z;
    ...
    public boolean contains(BlockData block) {
        ...
        for (net.minecraft.world.level.chunk.PalettedContainer<net.minecraft.world.level.block.state.BlockState> palette : blockids) {
    ...
    public boolean contains(Biome biome) {
        ...
        for (net.minecraft.world.level.chunk.PalettedContainerRO<net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome>> palette : this.biome) {
            if (palette.maybeHas(nms)) {
                return true;
            }
        }
    ...
    public final Biome getBiome(int x, int y, int z) {
        ...
        net.minecraft.world.level.chunk.PalettedContainerRO<net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome>> biome = this.biome[getSectionIndex(y)]; // SPIGOT-7188: Don't need to convert y to biome coordinate scale since it is bound to the block chunk section
    ...
    public final double getRawBiomeTemperature(int x, int y, int z) {
        ...
        net.minecraft.world.level.chunk.PalettedContainerRO<net.minecraft.core.Holder<net.minecraft.world.level.biome.Biome>> biome = this.biome[getSectionIndex(y)]; // SPIGOT-7188: Don't need to convert y to biome coordinate scale since it is bound to the block chunk section
        return biome.get(x >> 2, (y & 0xF) >> 2, z >> 2).value().getTemperature(new net.minecraft.core.BlockPos((this.x << 4) | x, y, (this.z << 4) | z));
    }
