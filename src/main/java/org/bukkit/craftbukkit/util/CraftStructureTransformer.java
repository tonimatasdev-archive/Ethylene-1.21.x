...
public class CraftStructureTransformer {
    ...
    public CraftStructureTransformer(net.minecraft.world.level.WorldGenLevel generatoraccessseed, net.minecraft.world.level.ChunkPos chunkcoordintpair, Collection<BlockTransformer> blockTransformers, Collection<EntityTransformer> entityTransformers) {
    ...
    public CraftBlockState transformCraftState(CraftBlockState originalState) {
        ...
        net.minecraft.core.BlockPos position = originalState.getPosition();
