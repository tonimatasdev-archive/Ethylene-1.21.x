...
final class CraftMinecartMobSpawner extends CraftMinecart implements SpawnerMinecart {
    ...
    public EntityType getSpawnedType() {
        net.minecraft.world.level.SpawnData spawnData = getHandle().getSpawner().nextSpawnData;
        if (spawnData == null) {
            return null;
        }
    ...
    public void setSpawnedType(EntityType entityType) {
        if (entityType == null) {
            getHandle().getSpawner().spawnPotentials = net.minecraft.util.random.SimpleWeightedRandomList.empty(); // need clear the spawnPotentials to avoid nextSpawnData being replaced later
            getHandle().getSpawner().nextSpawnData = new net.minecraft.world.level.SpawnData();
            return;
        }
        Preconditions.checkArgument(entityType != EntityType.UNKNOWN, "Can't spawn EntityType %s from mob spawners!", entityType);

        net.minecraft.util.RandomSource rand = getHandle().level().getRandom();
    ...
    @Override
    public net.minecraft.world.entity.vehicle.MinecartSpawner getHandle() {
        return (net.minecraft.world.entity.vehicle.MinecartSpawner) entity;
    }
