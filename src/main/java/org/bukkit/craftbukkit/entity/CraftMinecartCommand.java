...
public class CraftMinecartCommand extends CraftMinecart implements CommandMinecart {
    ...
    public CraftMinecartCommand(CraftServer server, net.minecraft.world.entity.vehicle.MinecartCommandBlock entity) {
        super(server, entity);
    }

    @Override
    public net.minecraft.world.entity.vehicle.MinecartCommandBlock getHandle() {
        return (net.minecraft.world.entity.vehicle.MinecartCommandBlock) entity;
    }
    ...
    public void setCommand(String command) {
        ...
        getHandle().getEntityData().set(net.minecraft.world.entity.vehicle.MinecartCommandBlock.DATA_ID_COMMAND_NAME, getHandle().getCommandBlock().getCommand());
    }
